...
import 'package:apidemo/pages/HomeScreen.dart';
import 'package:apidemo/pages/add_somethings.dart';
    ...
    return SafeArea(
      child: Scaffold(
        drawer: Drawer (
          child: ListView(
            ...
            children: [
              ...
              ListTile(
                title: const Text('Tài khoản leminhnamktpmk41'),
                onTap: () {
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (_) => PostSomething()));
          },
        ),
